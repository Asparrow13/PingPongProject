...
public class SpaceSelfMovingPaddle extends Actor
{
    private int width;
    private int height;
    private int dx;
    ...
    public SpaceSelfMovingPaddle(int width, int height)
    {
        this.width = width;
        this.height = height;
        dx = 1;
    ...
    public SpaceSelfMovingPaddle(int direction)
    {
    ...
    private void respawnAtRandomHeight()
    {
        ...
        SpacePaddle gamer = (SpacePaddle) world.getObjects(SpacePaddle.class).get(0);  // Assuming there's only one gamer paddle
